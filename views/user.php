...
<body>
    ...
    <main class="mt-10 mb-5">
        ...
        <h2 class="text-center text-black my-2">Bienvenido  <?php echo $_SESSION['user']['name']?></h2>

        <div class="text-center mb-5 p-10">
            <div class="w-full h-[80vh] rounded-xl bg-vaca bg-center md:bg-top bg-cover">
                <!-- <img src="img/fondo.jpg" alt="" class="w-full h-full object-cover object-center"> -->
            </div>
        </div>
        ...
        <section class="nosotros max-w-800 mx-auto p-8">
            ...
            <div class="about-img grid grid-cols-1 md:grid-cols-2 gap-8">
                <img src="img/cerdo.jpg" alt="Imagen 1" class="w-full h-auto mb-4 md:mb-0 rounded">
                <img src="img/doctor.jpg" alt="Imagen 2" class="w-full h-auto rounded">
            </div>
        </section>
    </main>
